...
data class DroneState(
    ...
    val capturedWaypoints: List<com.example.drones.localization.WaypointEntry> = emptyList(),
    val surveyCandidate: com.example.drones.localization.SurveyController.Candidate? = null,
